package abbosbek.mobiler.weatherforecast.adapter

import abbosbek.mobiler.weatherforecast.R
import abbosbek.mobiler.weatherforecast.databinding.ListItemBinding
...
class WeatherAdapter(val listener : Listener?) : ListAdapter<WeatherModel,WeatherAdapter.Holder>(Comparator()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.list_item,parent,false),listener)
    }
